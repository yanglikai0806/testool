...
//        SystemClock.sleep(500);
        ...
        if (password.length() > 0) {
            if (get_elements(true, "content-desc", "密码区域", 0) == null) {
                swipe(String.valueOf(0.5 * x), String.valueOf(0.9 * y), String.valueOf(0.5 * x), String.valueOf(0.1 * y), "200");
            }
//            SystemClock.sleep(100);
            ...
            swipe(String.valueOf(0.5 * x), String.valueOf(0.9 * y), String.valueOf(0.5 * x), String.valueOf(0.1 * y), "500");
        }
//        SystemClock.sleep(200);
    ...
    public static void press(String key) {
        switch (key) {
            ...
            case "recent":
                ...
                break;
            case "AIkey":
                AdbUtils.runShellCommand("input keyevent 689\n", 0);
                break;
            case "power":
    ...
    public static void openNotification() {
        ...
        swipe(String.valueOf(0.5 * x), String.valueOf(0.01 * y), String.valueOf(0.5 * x), String.valueOf(0.8 * y), "500");
        logUtil.i(TAG, "打开通知栏");
    ...
    public static void uninstallApp(String pkgName) {
        AdbUtils.runShellCommand("pm uninstall " + pkgName + "\n", 0);
...
//        logUtil.i(TAG, "打开activity：" + activityName);
        if (!getActivity().contains(activityName)) {
            String res = AdbUtils.runShellCommand("am start -n " + activityName + "\n", 0);
...
//                context.startActivity(intent);
    ...
    public static String launchApp(Object activity) throws JSONException {
...
//        logUtil.i(TAG, "打开activity：" + activityName);
    ...
    public static void killApp(String pkgName) {
        AdbUtils.runShellCommand("am force-stop " + pkgName + "\n", 0);
        SystemClock.sleep(1000);
    }
