...
public class EditeCaseAdapter extends BaseAdapter{
    // 填充数据的list
    ...
    // 构造器
    public EditeCaseAdapter(ArrayList<String> list, View.OnClickListener context) {
...
//                设置对话框消息
                String res = AdbUtils.runShellCommand("cat "+ TESTCASES_PATH + list.get(position).split("\\.")[1].trim() + ".json\n", 0);
...
//                });
    ...
    public static void setIsSelected(HashMap<Integer,Boolean> isSelected) {
        EditeCaseAdapter.isSelected = isSelected;
    }
