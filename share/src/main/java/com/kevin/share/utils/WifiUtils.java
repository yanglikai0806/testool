...
public class WifiUtils {
    ...
    public WifiUtils() {
        // 取得WifiManager对象
        mWifiManager = (WifiManager) AppContext.getContext().getApplicationContext().getSystemService(Context.WIFI_SERVICE);
        // 取得WifiInfo对象
        if (mWifiManager != null) {
            mWifiInfo = mWifiManager.getConnectionInfo();
        }

        mConnectManager = (ConnectivityManager) AppContext.getContext()
